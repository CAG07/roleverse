...
import schema from '@/lib/character/sheet-schema/dnd4e';

interface DND4ESheetProps {
  characterId: string;
...
export default function DND4ESheet({ characterId, data, equipment = [], compact }: DND4ESheetProps) {
